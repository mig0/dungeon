...
CELL_FLOOR_EXTENSIONS = (*CELL_FLOOR_TYPES_RANDGEN, CELL_PLATE, CELL_START, CELL_FINISH, CELL_PORTAL, CELL_GATE0, CELL_GATE1, CELL_KEY1, CELL_KEY2, CELL_LOCK1, CELL_LOCK2)
CELL_ENEMY_PLACE_OBSTACLES = (CELL_BORDER, CELL_PORTAL, CELL_GATE0, CELL_GATE1, CELL_SAND, CELL_KEY1, CELL_KEY2, CELL_LOCK1, CELL_LOCK2, CELL_VOID)
CELL_CHAR_PLACE_OBSTACLES = (CELL_BORDER, CELL_PLATE, CELL_PORTAL, CELL_GATE0, CELL_GATE1, CELL_SAND, CELL_KEY1, CELL_KEY2, CELL_LOCK1, CELL_LOCK2, CELL_VOID)
CELL_CHAR_MOVE_OBSTACLES  = (CELL_BORDER, CELL_GATE0, CELL_LOCK1, CELL_LOCK2, CELL_VOID)
