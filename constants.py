...
CELL_ENEMY_PLACE_OBSTACLES = (CELL_STATUS, CELL_BORDER, CELL_BARREL, CELL_PORTAL)
CELL_CHAR_PLACE_OBSTACLES = (CELL_STATUS, CELL_BORDER, CELL_BARREL, CELL_PORTAL, CELL_PLATE)
CELL_CHAR_MOVE_OBSTACLES  = (CELL_STATUS, CELL_BORDER)
