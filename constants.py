...
CELL_FLOOR_ADDITIONS = (*CELL_FLOOR_ADDITIONS_RANDGEN, CELL_PLATE, CELL_PORTAL, CELL_GATE0, CELL_GATE1)
CELL_ENEMY_PLACE_OBSTACLES = (CELL_BORDER, CELL_PORTAL, CELL_GATE0, CELL_GATE1)
CELL_CHAR_PLACE_OBSTACLES = (CELL_BORDER, CELL_PLATE, CELL_PORTAL, CELL_GATE0, CELL_GATE1)
CELL_CHAR_MOVE_OBSTACLES  = (CELL_BORDER, CELL_GATE0)
